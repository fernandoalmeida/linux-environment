...
aws iam create-policy \
    ...
    --policy-document file://install/docker_registry/aws-policy.json
...
account_id=$(aws iam get-account-authorization-details | grep -e ".*:policy/docker_registry" | tail -1 | sed 's/[^0-9]//g')
