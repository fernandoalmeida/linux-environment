...
define_webjump('jira', 'https://locaweb.atlassian.net/browse/%s')
define_webjump('fila', 'http://fila-beta.hospedagem.locaweb.com.br/LogGeral.aspx?prov=%s')
define_webjump('si', 'sistema-beta.hospedagem.locaweb.com.br')
...
define_webjump('grafana', 'https://dashboards.locaweb.com.br/')
